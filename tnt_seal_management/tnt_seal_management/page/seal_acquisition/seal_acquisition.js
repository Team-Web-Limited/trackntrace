frappe.pages["seal-acquisition"].on_page_load = function (wrapper) {
	...
	page.add_inner_button(__("Download Template"), () => _sa_download_template());
	if (_sa_can_manage()) {
		page.set_primary_action(__("Mass Import"), () => _sa_show_import_dialog(page));
		page.add_inner_button(__("New Acquisition"), () => frappe.new_doc("Seal Acquisition"));
	}
