...
def execute():
    ...
    for s in states:
        if not frappe.db.exists("Workflow State", s):
            ...
            print(f"Created Workflow State: {s}")
    ...
    if not frappe.db.exists("Workflow", "Seal Journey Workflow"):
        workflow = frappe.get_doc({
            ...
            "states": [
                ...
                {"state": "Finance PCB Approved", "doc_status": 1, "allow_edit": "Team Lead Technician"},
                {"state": "Finance PCB Rejected", "doc_status": 0, "allow_edit": "All"},
                {"state": "Team Lead Assigned", "doc_status": 1, "allow_edit": "Team Lead Technician"},
            ...
            "transitions": [
                ...
                {"state": "Team Lead Assigned", "action": "Assign Technician", "next_state": "Technician Assigned", "allowed": "Team Lead Technician"},
